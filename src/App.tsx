...
function App() {
  ...
  return <main className="site-shell">
    ...
    <section className="hero" id="top"><div className="hero-copy"><p className="kicker">SIH26034 / Mission control</p><h1>READ<br /><em>THE</em> LABEL.</h1><p className="hero-text">AI-powered packaged commodity inspection for safer choices, clearer labels, and smarter price decisions.</p><a className="scroll-cue" href="#scan"><span>↓</span> Launch scanner</a></div><div className="hero-art"><div className="hero-grid" /><div className="scan-orbit"><span>OCR</span><span>BARCODE</span><span>VISION AI</span></div><div className="package-graphic"><i /><b /><strong>SCAN<br />ME</strong></div><span className="hero-stamp">DETECT<br />VALIDATE<br />ANALYZE</span></div></section>
