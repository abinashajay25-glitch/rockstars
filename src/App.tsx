...
function App() {
  ...
  const downloadPdf = async () => {
    ...
    pdf.setFillColor(...orange); pdf.rect(15, 250, 180, 18, 'F'); pdf.setTextColor(10, 10, 9); pdf.setFont('helvetica', 'bold'); pdf.setFontSize(10); pdf.text(`COMPLIANCE ${analysis.complianceScore}% / ${analysis.complianceStatus}`, 20, 261)
    drawFooter()
